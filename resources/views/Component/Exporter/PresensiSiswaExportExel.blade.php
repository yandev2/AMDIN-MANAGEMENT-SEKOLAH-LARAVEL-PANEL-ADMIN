            ...
            <thead>
                ...
                <tr>
                    <th style="background-color: #3ac1ff; text-align: center; font-size: 10px; color: white; font-weight: 600;"
                        colspan="2">NOMOR</th>
                    <th style="background-color: #3ac1ff; text-align: center; vertical-align: middle; font-size: 10px; color: white; font-weight: 600; width:  200px"
                        rowspan="3">
                        NAMA</th>
                    <th style="background-color: #3ac1ff; text-align: center; vertical-align: middle; font-size: 10px; color: white; font-weight: 600; width: 30px; "
                        rowspan="3">
                        L/P</th>
                    <th style="background-color: #3ac1ff; text-align: center; vertical-align: middle; font-size: 10px; color: white; font-weight: 600; width: 80px; "
                        rowspan="3">
                        Kelas</th>
                    <th style="background-color: #3ac1ff; text-align: center; font-size: 10px; color: white; font-weight: 600;"
                        colspan={{ $jumlahHari }}>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style=" text-align: center;">{{ $siswa['jk']}}</td>
                      <td style=" text-align: center;">{{ $json['kelas']['nama_kelas']}}</td>
