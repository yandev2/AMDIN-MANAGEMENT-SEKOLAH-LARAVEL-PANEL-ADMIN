...
class PresensiGuruExportExel implements FromView, WithStyles, WithEvents
{
    ...
    {
        return view('component.exporter.PresensiGuruExportExel', [
            'json' => $this->data
        ]);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $range = 'A4:' . $highestColumn . $highestRow-5;
